...
require_relative 'collective_access/search'
require_relative 'collective_access/item_info'
require_relative 'collective_access/cataloguing'
  ...
  module Services
    class CollectiveAccess
      ...
      def initialize(host = nil)
        @search = CollectiveAccessService::Search.new host
        @info = CollectiveAccessService::ItemInfo.new host
        @cata = CollectiveAccessService::Cataloguing.new host
      end
