require_relative 'rosetta/pds_handler'
require_relative 'rosetta/producer_handler'
require_relative 'rosetta/deposit_handler'
require_relative 'rosetta/sip_handler'
require_relative 'rosetta/ie_handler'
  ...
  module Services
    ...
    class Rosetta
      ...
      def initialize(base_url = 'http://depot.lias.be')
        @pds_service = LIBIS::Services::RosettaService::PdsHandler.new
        @producer_service = LIBIS::Services::RosettaService::ProducerHandler.new base_url
        @deposit_service = LIBIS::Services::RosettaService::DepositHandler.new base_url
        @sip_service = LIBIS::Services::RosettaService::SipHandler.new base_url
        @ie_service = LIBIS::Services::RosettaService::IeHandler.new base_url
      end
